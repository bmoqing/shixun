	...
	<div class="con">
		...
		<el-dialog title="头像信息" :visible.sync="dialogFormVisible" @close="dialogClose">
			<el-form :model="form" ref="form">
				<el-form-item label="banner名称" :label-width="formLabelWidth" class="widthControl">
					<el-input v-model="form.name" autocomplete="off"></el-input>
				</el-form-item>
				<el-form-item label="图片" :label-width="formLabelWidth">
					<el-upload class="avatar-uploader" ref="upload" :action="action" :show-file-list="false"
					 :before-upload="beforeUpload" :on-change="handleChange" :auto-upload="false" :on-success="handleAvatarSuccess"
					 :data="{ bannerJson: JSON.stringify(form)}">
	...
	export default {
		...
		data() {
			return {
				...
				action: this.$global_msg.adminRoute + '/banner/addBanner'
			};
		},
		methods: {
